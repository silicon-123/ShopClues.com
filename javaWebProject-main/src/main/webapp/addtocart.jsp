...
int productId = (Integer) session.getAttribute("productId");
    ...
    try (Connection conn = DriverManager.getConnection(dbURL, dbUser, dbPasswd)) {
    	...
    	String checkQuery = "SELECT quantity FROM cart WHERE customerId = ? AND productId = ?";
    	...
    	if (checkResult.next()) {
    	    ...
    	    String updateQuery = "UPDATE cart SET quantity = ? WHERE customerId = ? AND productId = ?";
    	    ...
    	    String insertQuery = "INSERT INTO cart (customerId, productId, quantity) VALUES (?, ?, 1)";
        ...
        e.printStackTrace();
        out.println("<p>An error occurred while adding the product to the cart.</p>"+e);
        return;
    }
